...
- Flag when proposed changes add visual noise without clear user value

## Focus — Completeness

- Does the visual design hold up across all states (empty, full, overflow)?
- Are colors, spacing, and typography consistent?
- Would this look polished in a real screenshot?
- Are responsive breakpoints accounted for?
